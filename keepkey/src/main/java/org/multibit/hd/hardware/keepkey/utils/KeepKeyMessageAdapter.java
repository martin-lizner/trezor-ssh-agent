...
/**
 * <p>Adapter to provide the following to KeepKey messages:</p>
 * <ul>
 * <li>Adaption from a KeepKey message to a Core message</li>
 * </ul>
 *
 ...
 *  
 */
public class KeepKeyMessageAdapter {
   ...
   * @return The adapted Core message
   */
  public static Features adaptFeatures(KeepKeyMessage.Features source) {
    ...
    for (KeepKeyType.CoinType coinType : source.getCoinsList()) {
   ...
   * @return The adapted Core message
   */
  public static Failure adaptFailure(KeepKeyMessage.Failure source) {
   ...
   * @return The adapted Core message
   */
  public static FailureType adaptFailureType(KeepKeyType.FailureType source) {
   ...
   * @return The adapted Core message
   */
  public static ButtonRequest adaptButtonRequest(KeepKeyMessage.ButtonRequest source) {
   ...
   * @return The adapted Core message
   */
  public static ButtonRequestType adaptButtonRequestType(KeepKeyType.ButtonRequestType source) {
   ...
   * @return The adapted Core message
   */
  public static PinMatrixRequest adaptPinMatrixRequest(KeepKeyMessage.PinMatrixRequest source) {
   ...
   * @return The adapted Core message
   */
  public static PinMatrixRequestType adaptPinMatrixRequestType(KeepKeyType.PinMatrixRequestType source) {
   ...
   * @return The adapted Core message
   */
  public static MainNetAddress adaptAddress(KeepKeyMessage.Address source) {
   ...
   * @return The adapted Core message
   */
  public static PublicKey adaptPublicKey(KeepKeyMessage.PublicKey source) {
   ...
   * @return The adapted Core message
   */
  public static HDNodeType adaptHDNodeType(KeepKeyType.HDNodeType source) {
   ...
   * @return The adapted Core message
   */
  public static TxRequest adaptTxRequest(KeepKeyMessage.TxRequest source) {
   ...
   * @return The adapted Core message
   */
  private static TxRequestType adaptTxRequestType(KeepKeyType.RequestType source) {
   ...
   * @return The adapted Core message
   */
  private static TxRequestDetailsType adaptTxRequestDetailsType(KeepKeyType.TxRequestDetailsType source) {
   ...
   * @return The adapted Core message
   */
  private static TxRequestSerializedType adaptTxRequestSerializedType(KeepKeyType.TxRequestSerializedType source) {
   ...
   * @return The adapted Core message
   */
  public static MessageSignature adaptMessageSignature(KeepKeyMessage.MessageSignature source) {
   ...
   * @return The adapted Core message
   */
  public static CipheredKeyValue adaptCipheredKeyValue(KeepKeyMessage.CipheredKeyValue source) {
