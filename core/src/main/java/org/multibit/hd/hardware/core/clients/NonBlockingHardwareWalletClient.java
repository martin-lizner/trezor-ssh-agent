 ...
 * </ul>
 * <p>Please refer to the {@link org.multibit.hd.hardware.core.clients.BlockingHardwareWalletClient} if making
 ...
 * <p>Non-blocking implementations will delegate operations to internal threads and rely on events to avoid holding up the calling code.</p>
 *
 * @since 0.0.1
 *  
 */
public interface NonBlockingHardwareWalletClient {
   ...
   */
  public void optAck(char[] oneTimePassword);
   ...
   */
  public void setMaxFeeKb(long satoshisPerKb);
   ...
   */
  public void getAddress(int index, int value);
   ...
   *                after use.
   */
  public void resetDevice(byte[] entropy);
   ...
   */
  public void sendDefaultBlockingMessage(Message message);
   ...
   * @throws IllegalStateException If anything goes wrong
   */
  public void sendBlockingMessage(Message message, int duration, TimeUnit timeUnit);
