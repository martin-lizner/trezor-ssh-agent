package org.multibit.hd.hardware.examples.keepkey.usb.step1;
...
/**
 * <p>Step 1 - Verify KeepKey exists on USB</p>
 ...
 *  
 */
public class KeepKeyV1FeaturesExample {

  private static final Logger log = LoggerFactory.getLogger(KeepKeyV1FeaturesExample.class);
  ...
  public static void main(String[] args) throws Exception {
    ...
    KeepKeyV1FeaturesExample example = new KeepKeyV1FeaturesExample();
