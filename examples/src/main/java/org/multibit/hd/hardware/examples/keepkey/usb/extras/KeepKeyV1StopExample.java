...
/**
 * <p>Verify KeepKey exists on USB and service can be stopped cleanly</p>
 * <p>Requires KeepKey V1 production device plugged into a USB HID interface.</p>
 * <p>Do the following:</p>
 * <ol>
 *   <li>Start with the KeepKey detached</li>
 *   <li>Attach the KeepKey, observe the Feature message</li>
 *   <li>Detach the KeepKey, observe the service shutdown</li>
 *   <li>Type something to initiate the service restart</li>
 *   <li>Attach the KeepKey, observe the Feature message</li>
 * </ol>
 *
 * <p>This example demonstrates the initial verification of recognising insertion and removal of a KeepKey following by restarting
 ...
 *  
 */
public class KeepKeyV1StopExample {

  private static final Logger log = LoggerFactory.getLogger(KeepKeyV1StopExample.class);
  ...
  public static void main(String[] args) throws Exception {
    ...
    KeepKeyV1StopExample example = new KeepKeyV1StopExample();
